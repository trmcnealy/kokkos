...
if [ "$1" = "cmake" ]; then
    ...
    -DCMAKE_INSTALL_PREFIX="E:/AssemblyCache/kokkos/Debug" \
    ...
    find . -name 'flags.make' -exec sed -i -e 's/ -fopenmp=libomp -march=core-avx2 -mtune=core-avx2 -x cuda --cuda-gpu-arch=sm_52 / /g' {} \;       
